...
import { useQueryGraphStep, createOrderWorkflow, beginOrderEditOrderWorkflow } from "@medusajs/medusa/core-flows"
import { CreateOrderWorkflowInput, CreateOrderLineItemDTO } from "@medusajs/framework/types"
...
export const createRequestForQuoteWorkflow = createWorkflow(
  ...
  (input: WorkflowInput) => {
    ...
    const changeOrderInput = transform({ draftOrder }, ({ draftOrder }) => {
      return {
