...
import { Save, Upload, ArrowLeft, LoaderCircle, Layers, Box, Tag, ArrowRight, Check, AlertCircle } from "lucide-react"
...
/**
 * Cedar Category Creation - Golden Rule Implementation
 * 
 * Categories NEVER select products.
 * Products assign themselves to categories.
 * This page only creates category STRUCTURE.
 */
...
export default function CreateCategoryPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Create category (NO PRODUCT ASSIGNMENT)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Create category structure - products will assign themselves later
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Technical classification like Residential, Commercial, Industrial, Hospital.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
                        ...
                        <p className="text-xs text-gray-500">
                          {categoryMode === 'main'
                            ? "A main category sits directly under an Application (e.g. Erection > Motors)."
                            : "A subcategory sits under a Main Category (e.g. Erection > Motors > AC Motors)."
                          }
                        </p>
                      </div>
