      ...
      <div className="flex">
        ...
        <aside className="hidden lg:block w-64 bg-transparent p-4 space-y-4 fixed top-16 left-0 bottom-0 animate-pulse">
          ...
          <div className="space-y-2">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="h-10 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"></div>
            ))}
          </div>
        </aside>
        ...
        <div className="flex-1 lg:ml-64">
          <main className="py-6 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 sm:p-8 lg:p-10 animate-pulse">
                {/* Title */}
