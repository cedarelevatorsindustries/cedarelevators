...
export const metadata: Metadata = {
    title: "Shipping Policy | Cedar Elevators",
    description: "Learn about our shipping methods, timelines, and costs for elevator components.",
}

export default async function ShippingPolicyPage() {
    const { data: policy } = await getPolicyByTypeAction('shipping')
        ...
        <div className="bg-white min-h-screen pb-16">
            ...
            <div className="container mx-auto max-w-6xl px-4 mt-16">
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 text-center border border-orange-200">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Questions About Shipping?</h3>
                    <p className="text-gray-600 mb-6">Our logistics team is here to help with your delivery needs.</p>
                    <Link href="/contact">
