...
export const metadata: Metadata = {
    title: "Terms & Conditions | Cedar Elevators",
    description: "Read our terms and conditions for using Cedar Elevators platform.",
}

export default async function TermsConditionsPage() {
    const { data: policy } = await getPolicyByTypeAction('terms')
        ...
        <div className="bg-white min-h-screen pb-16">
            ...
            <div className="container mx-auto max-w-6xl px-4 space-y-12">
                {policy?.content && policy.content.length > 0 ? (
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-orange-600 mb-4">Terms & Conditions</h2>
            ...
            <div className="container mx-auto max-w-6xl px-4 mt-16">
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 text-center border border-orange-200">
                    ...
                    <p className="text-gray-600 mb-6">Contact our legal team for clarification.</p>
                    <Link href="/contact">
