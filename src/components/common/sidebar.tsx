                ...
                <Link href="/admin" className={cn(
                    ...
                    {!collapsed && (
                        <div className="min-w-0 flex-1">
                            <span className="text-sm lg:text-base xl:text-lg font-bold text-gray-900 dark:text-white block truncate">Cedar Admin</span>
                            <p className="text-xs text-gray-500 dark:text-gray-400 truncate hidden sm:block">Elevator Solutions</p>
                        </div>
                    )}
                </Link>
            </div>
