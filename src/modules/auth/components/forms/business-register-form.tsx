    ...
    <div className="w-full space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 text-sm font-normal leading-normal mt-2">
          Access trade pricing and B2B features
        </p>
      </div>

      {/* Social Sign Up */}
      <div className="flex flex-col gap-3">
        <button type="button" onClick={handleGoogleSignUp} className="flex w-full h-12 items-center justify-center gap-2 rounded-lg bg-gray-100 px-5 text-base font-bold text-gray-800 hover:bg-gray-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start">
          <div className="flex items-center h-5">
            <input
              ...
              required
              className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-[#F97316] focus:ring-[#F97316]"
            />
          </div>
        ...
        <button
          ...
          className="flex w-full h-12 items-center justify-center rounded-lg bg-[#F97316] px-5 text-base font-bold text-white hover:bg-[#F97316]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F97316] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Create Account
        </button>
      </form>
