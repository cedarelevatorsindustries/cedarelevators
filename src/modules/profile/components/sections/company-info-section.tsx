    ...
    <div className={cn('mx-auto max-w-4xl', className)}>
      ...
      <div className="flex flex-col gap-10 pt-8">
        ...
        <section className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-gray-900 dark:text-white text-lg font-bold">Company Logo</p>
            ...
            <button
              ...
              className="flex h-10 min-w-[84px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-700 px-4 text-sm font-bold text-gray-900 dark:text-white transition-colors hover:bg-gray-200 dark:hover:bg-gray-600 sm:w-auto"
            >
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 md:grid-cols-2">
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="legalName">
                Legal Company Name
              </label>
              <input
                className="w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#F97316]/50 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#F97316] h-12 placeholder:text-gray-500 px-4 text-base font-normal leading-normal"
                id="legalName"
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="taxId">
                Tax ID / GSTIN
              </label>
              <input
                className="w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#F97316]/50 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#F97316] h-12 placeholder:text-gray-500 px-4 text-base font-normal leading-normal"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="industry">
                Industry / Type
              </label>
              <select
                className="w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#F97316]/50 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#F97316] h-12 px-4 text-base font-normal leading-normal"
                id="industry"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="companySize">
                Company Size
              </label>
              <select
                className="w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#F97316]/50 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#F97316] h-12 px-4 text-base font-normal leading-normal"
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-gray-900 dark:text-white">Billing Address</h3>
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 md:grid-cols-2">
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="contactEmail">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-medium text-gray-900 dark:text-white" htmlFor="contactPhone">
