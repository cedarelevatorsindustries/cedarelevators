...
export default function BusinessVerificationSection({
  ...
  const getStatusBadge = () => {
    switch (verificationStatus) {
      ...
      case 'pending':
        return (
          <div className="flex items-center gap-2 px-4 py-2 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-900/30 rounded-lg">
      ...
      case 'rejected':
        return (
          <div className="flex items-center gap-2 px-4 py-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 rounded-lg">
            <XCircle className="text-red-600 dark:text-red-400" size={20} />
            <span className="text-red-700 dark:text-red-400 font-semibold">Verification Rejected</span>
          </div>
        )
      default:
        return (
