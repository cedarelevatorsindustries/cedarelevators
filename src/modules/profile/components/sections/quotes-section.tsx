...
export default function QuotesSection({ accountType, verificationStatus }: QuotesSectionProps) {
  ...
  const handleDownloadCSV = async () => {
    try {
      ...
      const result = await exportQuotesToCSV()
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm">
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            >
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900 font-medium">{quote.items?.length || 0}</span>
                  </div>
                  <div className="flex justify-between text-sm">
        ...
        {/* Recommended Products - Temporarily disabled */}
        {/* {filteredQuotes.length > 0 && (
