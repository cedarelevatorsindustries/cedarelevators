      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex flex-1 justify-end items-center gap-4">
          ...
          <div className="relative w-full max-w-sm hidden md:block">
            ...
            <input
              className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#F97316] border border-gray-200 h-10 placeholder:text-gray-500 pl-10 pr-4 text-sm font-normal"
              placeholder="Search products, orders..."
            />
          </div>

          {/* Notifications */}
          <button className="flex cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 w-10 bg-white text-gray-600 hover:bg-gray-100 border border-gray-200">
            <Bell size={20} />
          </button>
          ...
          {user && (
            <Link href="/account/profile">
              {user.avatar_url ? (
                ...
                <div className="bg-[#1E3A8A] text-white rounded-full size-10 flex items-center justify-center text-sm font-semibold border-2 border-white">
